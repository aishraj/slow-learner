...
def blog_index():
    ...
    cursor = posts.find().sort('date', direction = -1).limit(10) # so this code won't crash before you add your stuff - you can remove
...
def post_newcomment():
    ...
    post = posts.find_one({'permalink': permalink}, {'$push': {'comments': comment}}, upsert=False,manipulate=False, safe = True)  # Replace this line with your work.
